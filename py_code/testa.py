...
def python_string_callback(a, b):
    print(type(a), a)
    print(type(b), b)
    return 1
cdecl_string_pfunc = ctypes.CFUNCTYPE(ctypes.c_int, ctypes.c_char_p, ctypes.c_wchar_p)
string_callback_pfunc = ctypes.CFUNCTYPE(ctypes.c_int, cdecl_string_pfunc, ctypes.c_char_p, ctypes.c_wchar_p) 
string_callback_offset = 0x3713A2 - 0x360000
string_callback = string_callback_pfunc(base+string_callback_offset)
result = string_callback(cdecl_string_pfunc(python_string_callback), ctypes.c_char_p(b"python char string"), ctypes.c_wchar_p("python wchar string"))
print("add_callback: ", result)
